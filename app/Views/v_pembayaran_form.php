                    ...
                    <div class="card-body">
                        <form action="<?=$action?>" method="POST" class=" needs-validation " novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="validationCustom04" class="form-label">Tanggal Pembayaran</label>
                                        <input type="date" class="form-control" name="tgl_pembayaran" value="<?=$tgl_pembayaran?>"  >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="validationCustom04" class="form-label">Nilai Pembayaran</label>
                                        <input type="text" class="form-control number" name="pembayaran" value="<?=number_format($pembayaran)?>"  >
                                    </div>
                                </div>
